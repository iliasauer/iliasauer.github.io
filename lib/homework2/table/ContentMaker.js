      ...
      d3Collection.nest()
                ...
                .rollup((continentData) => {
                  const aggregatedDatum = {
                    ...
                    gdp: d3Array.sum(continentData, obj => obj.gdp),
                    population: d3Array.sum(continentData, obj => obj.population),
                    life_expectancy: d3Array.mean(continentData, obj => obj.life_expectancy),
